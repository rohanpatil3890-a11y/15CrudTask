...
@Component({
  selector: 'app-product-bashboard',
  templateUrl: './product-bashboard.component.html',
  styleUrls: ['./product-bashboard.component.scss']
})
export class ProductBashboardComponent implements OnInit {
